...
class FloorTest {
	...
	void test() throws ParseException {
		...
		// hard code expected values from data.txt in to message format comparable to one from floor
		SimpleDateFormat sdf = new SimpleDateFormat("hh:mm:ss.S");
		String[] dates = {"09:09:09.1", "11:11:11.1", "12:45:06.7", "13:04:56.5", "14:05:15.0",
				 "17:00:00.0", "17:20:10.1", "17:30:00.0", "16:05:34.4", "16:50:50.5"};
		Date date;
		...
		// now we have time array, create ControlDate array and hard code remaining values
		...
		// compare ControlDate array (expected values) to ones retrieved from Floor (actual values)
		for (int i = 0; i < 10; i++) {
